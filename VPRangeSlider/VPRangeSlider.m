...
// https://github.com/varunpm1/VPRangeSlider
...
- (void)setDefaultValues
{
    ...
    self.rangeDisplayLabelFont = [UIFont boldSystemFontOfSize:15.0f];
    ...
    self.minRangeLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 40, 20)];
    ...
    self.minRangeLabel.backgroundColor=[UIColor whiteColor];
    self.minRangeLabel.layer.cornerRadius = 20.0;
    self.minRangeLabel.layer.masksToBounds = true;

    [self addSubview:self.minRangeLabel];
    
    self.maxRangeLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 40, 20)];
    ...
    self.maxRangeLabel.backgroundColor=[UIColor whiteColor];
    self.maxRangeLabel.layer.cornerRadius = 20.0;
    self.maxRangeLabel.layer.masksToBounds = true;
...
// pour cacher certains elements en laissaint les labels visibles

-(void)partialyHide:(bool)hide{
    
    self.sliderBackgroundView.hidden=hide;
    self.sliderForegroundView.hidden=hide;
    self.startSliderButton.hidden=hide;
    self.endSliderButton.hidden=hide;
